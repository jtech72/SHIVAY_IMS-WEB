...
export const InventoryActionTypes = {
    ...
    VIEW_PRODUCT_FIRST: 'VIEW_PRODUCT_FIRST',
    VIEW_PRODUCT_LOADING: 'VIEW_PRODUCT_LOADING',
    VIEW_PRODUCT_SUCCESS: 'VIEW_PRODUCT_SUCCESS',
    VIEW_PRODUCT_ERROR: 'VIEW_PRODUCT_ERROR',
    VIEW_PRODUCT_RESET: 'VIEW_PRODUCT_RESET'
